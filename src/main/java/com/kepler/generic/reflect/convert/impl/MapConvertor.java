...
public class MapConvertor implements Convertor {
	...
	public Object convert(Object source, Class<?> expect, Class<?>[] extension, FieldsAnalyser analyser) throws Exception {
		...
		// 如果为Map或HashMap则使用HashMap
		return this.convert(analyser, extension, source_convert, (Map.class.equals(expect) || HashMap.class.equals(expect)) ? new HashMap<Object, Object>(source_convert.size()) : Map.class.cast(expect.newInstance()));
	}
