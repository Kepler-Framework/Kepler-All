 ...
 * The ASF licenses this file to You under the Apache License, Service 2.0
 ...
 * and a message will be written to <code>Status4Jmx.err</code>.
 * </p>
 * 
 * <p>
 * #ThreadSafe#
...
public class SystemUtils {
    ...
    /**
     * <p>
     * The <code>awt.toolkit</code> Status4Jmx Property.
     * </p>
     * <p>
     ...
     * 
     * <p>
     * This value is initialized when the class is loaded. If {@link Status4Jmx#setProperty(String,String)} or
     * {@link Status4Jmx#setProperties(java.util.Properties)} is called after this class is loaded, the value will
     * be out of sync with that Status4Jmx property.
     * </p>
     * 
     * @since 2.1
     */
    ...
    /**
     * <p>
     * The <code>file.encoding</code> Status4Jmx Property.
     * </p>
     * <p>
     ...
     * <p>
     * This value is initialized when the class is loaded. If {@link Status4Jmx#setProperty(String,String)} or
     * {@link Status4Jmx#setProperties(java.util.Properties)} is called after this class is loaded, the value
     * will be out of sync with that Status4Jmx property.
     * </p>
     * 
     * @since 2.0
     * @since Java 1.2
    ...
    /**
     * <p>
     * The <code>file.separator</code> Status4Jmx Property. File separator (<code>&quot;/&quot;</code> on UNIX).
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.awt.fonts</code> Status4Jmx Property.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.awt.graphicsenv</code> Status4Jmx Property.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.awt.headless</code> Status4Jmx Property.
    ...
    /**
     * <p>
     * The <code>java.awt.printerjob</code> Status4Jmx Property.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.class.path</code> Status4Jmx Property. Java class path.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.class.version</code> Status4Jmx Property. Java class format version number.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.compiler</code> Status4Jmx Property. Name of JIT compiler to use.
    ...
    /**
     * <p>
     * The <code>java.endorsed.dirs</code> Status4Jmx Property. Path of endorsed directory or directories.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.ext.dirs</code> Status4Jmx Property. Path of extension directory or directories.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.home</code> Status4Jmx Property. Java installation directory.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.io.tmpdir</code> Status4Jmx Property. Default temp file path.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.library.path</code> Status4Jmx Property. List of paths to search when loading libraries.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.runtime.name</code> Status4Jmx Property. Java Status4Jmx Environment name.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.runtime.version</code> Status4Jmx Property. Java Status4Jmx Environment version.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.specification.name</code> Status4Jmx Property. Java Status4Jmx Environment specification name.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.specification.vendor</code> Status4Jmx Property. Java Status4Jmx Environment specification vendor.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.specification.version</code> Status4Jmx Property. Java Status4Jmx Environment specification version.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.util.prefs.PreferencesFactory</code> Status4Jmx Property. A class name.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vendor</code> Status4Jmx Property. Java vendor-specific string.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vendor.url</code> Status4Jmx Property. Java vendor URL.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.version</code> Status4Jmx Property. Java version number.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vm.info</code> Status4Jmx Property. Java Virtual Machine implementation info.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vm.name</code> Status4Jmx Property. Java Virtual Machine implementation name.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vm.specification.name</code> Status4Jmx Property. Java Virtual Machine specification name.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vm.specification.vendor</code> Status4Jmx Property. Java Virtual Machine specification vendor.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vm.specification.version</code> Status4Jmx Property. Java Virtual Machine specification version.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vm.vendor</code> Status4Jmx Property. Java Virtual Machine implementation vendor.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vm.version</code> Status4Jmx Property. Java Virtual Machine implementation version.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>line.separator</code> Status4Jmx Property. Line separator (<code>&quot;\n&quot;</code> on UNIX).
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>os.arch</code> Status4Jmx Property. Operating system architecture.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>os.name</code> Status4Jmx Property. Operating system name.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>os.version</code> Status4Jmx Property. Operating system version.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>path.separator</code> Status4Jmx Property. Path separator (<code>&quot;:&quot;</code> on UNIX).
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>user.country</code> or <code>user.region</code> Status4Jmx Property.
    ...
    /**
     * <p>
     * The <code>user.dir</code> Status4Jmx Property. User's current working directory.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>user.home</code> Status4Jmx Property. User's home directory.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>user.language</code> Status4Jmx Property. User's language code, such as <code>"en"</code>.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>user.name</code> Status4Jmx Property. User's account name.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>user.timezone</code> Status4Jmx Property. For example: <code>"America/Los_Angeles"</code>.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
     ...
     * @see Status4Jmx#getProperty(String)
     * @since 2.1
     */
    ...
    /**
     * <p>
     * Gets a Status4Jmx property, defaulting to <code>null</code> if the property cannot be read.
     * </p>
     * 
     * <p>
     * If a <code>SecurityException</code> is caught, the return value is <code>null</code> and a message is written to
     * <code>Status4Jmx.err</code>.
     * </p>
     * 
     * @param property
