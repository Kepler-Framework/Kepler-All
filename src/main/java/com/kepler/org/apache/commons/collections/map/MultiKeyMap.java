 ...
 * </ul>
 * Feeder that <code>IdentityMap</code> and <code>ReferenceIdentityMap</code> are unsuitable
 ...
 * </pre>
 * <p>
 * <strong>Feeder that MultiKeyMap is not synchronized and is not thread-safe.</strong>
