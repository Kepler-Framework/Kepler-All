 ...
 */
package com.kepler.org.apache.commons.lang.reflect;
 ...
 * </p>
 * 
 * <h3>Known Limitations</h3> <h4>Accessing Public Methods In A Default Access Superclass</h4>
 * <p>
 * There is an issue when invoking public methods contained in a default access superclass on JREs prior to 1.4. Reflection locates these methods fine and correctly assigns them as public. However, an <code>IllegalAccessException</code> is thrown if the method is invoked.
 * </p>
 * 
 * <p>
 * <code>MethodUtils</code> contains a workaround for this situation. It will attempt to call <code>setAccessible</code> on this method. If this call succeeds, then the method can be invoked as normal. This call will only succeed when the application has sufficient security privileges. If this call fails then the method may fail.
 * </p>
 * 
...
public class MethodUtils {
	...
	/**
	 * <p>
	 * MethodUtils instances should NOT be constructed in standard programming. Instead, the class should be used as <code>MethodUtils.getAccessibleMethod(method)</code>.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * This method supports calls to methods taking primitive parameters via passing in wrapping classes. So, for example, a <code>Boolean</code> object would match a <code>boolean</code> primitive.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * This uses reflection to invoke the method obtained from a call to <code>getAccessibleMethod()</code>.
	 * </p>
	 * 
	 * @param object invoke method on this object
	 * @param methodName get method with this name
	 ...
	 * 
	 * <p>
	 * This method supports calls to methods taking primitive parameters via passing in wrapping classes. So, for example, a <code>Boolean</code> class would match a <code>boolean</code> primitive.
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * <p>
	 * Return an accessible method (that is, one that can be invoked via reflection) with given name and a single parameter. If no such method can be found, return <code>null</code>. Basically, a convenience wrapper that constructs a <code>Class</code> array for you.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Return an accessible method (that is, one that can be invoked via reflection) with given name and parameters. If no such method can be found, return <code>null</code>. This is just a convenient wrapper for {@link #getAccessibleMethod(Method method)}.
	 * </p>
	 * 
	 * @param cls get method from this class
	 * @param methodName get method with this name
	...
	/**
	 * <p>
	 * Return an accessible method (that is, one that can be invoked via reflection) that implements the specified Method. If no such method can be found, return <code>null</code>.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Return an accessible method (that is, one that can be invoked via reflection) by scanning through the superclasses. If no such method can be found, return <code>null</code>.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Return an accessible method (that is, one that can be invoked via reflection) that implements the specified method, by scanning through all implemented interfaces and subinterfaces. If no such method can be found, return <code>null</code>.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * This method can match primitive parameter by passing in wrapper classes. For example, a <code>Boolean</code> will match a primitive <code>boolean</code> parameter.
	 * 
