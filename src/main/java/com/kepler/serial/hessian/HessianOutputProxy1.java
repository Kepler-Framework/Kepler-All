 ...
 *
 */
public class HessianOutputProxy1 implements HessianOutputProxy {

	private final HessianOutput output;

	public HessianOutputProxy1(OutputStream stream, int buffer) {
		this.output = new HessianOutput(new BufferedOutputStream(stream, buffer));
	}
